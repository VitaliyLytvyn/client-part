...
public class VideoAdapter
    ...
    /**
     * Change a Video's rating and notify the change.
     */
    public void changeRating(int num, double rating) {

        videoList.get(num).setStarRating(rating);
