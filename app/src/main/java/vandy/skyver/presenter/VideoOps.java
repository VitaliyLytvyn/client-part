package vandy.skyver.presenter;

import java.lang.ref.WeakReference;
import java.util.List;

import vandy.skyver.common.ConfigurableOps;
import vandy.skyver.common.ContextView;
import vandy.skyver.common.GenericAsyncTask;
import vandy.skyver.common.GenericAsyncTaskOps;
...
public class VideoOps
    ...
    /**
     * Gets a Video from the List and change its rating.
     */
    public void changeRating(int position, double rating){

        mAdapter.changeRating(position, rating);
    }
